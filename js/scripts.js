/* Mutation Observer for titleBox
   Title Text respond to body DOM class
-----------------------------*/
...
!function($){
  ...
  $.fn.onepage_scroll = function(options){
    ...
    if (settings.pagination == true) {
      if ($('ul.onepage-pagination').length < 1) $("<div class='pgWrapper'><ul class='onepage-pagination'></ul></div>").prependTo("body");
